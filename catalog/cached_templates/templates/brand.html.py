...
_magic_number = 9
_modified_time = 1397212024.759213
_enable_loop = True
_template_filename = 'C:\\app\\catalog\\templates/brand.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        brand_request = context.get('brand_request', UNDEFINED)
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 9
        __M_writer(str( brand_request.brand_name))
