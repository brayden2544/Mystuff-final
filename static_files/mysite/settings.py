...
INSTALLED_APPS = (
    ...
    #'django.contrib.sites',  Used for multiple django sites
    ...
    'manage',                  # Intex Mystuff App
    'catalog',                 # Product Catalog and Shopping Cart
...
DATABASES = {
 'default': {
	 ...
	 'NAME': 'mystuff',                      # Or path to database file if using sqlite3.
...
EMAIL_HOST = 'mail.byuisys.com'
# Port for sending e-mail.
EMAIL_PORT = 25
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# Optional SMTP authentication information for EMAIL_HOST.
EMAIL_HOST_USER = 'austen@byuisys.com'
